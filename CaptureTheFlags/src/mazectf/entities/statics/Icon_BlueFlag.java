...
public class Icon_BlueFlag extends StaticEntity {
	
	private boolean visible=false;
	
	public Icon_BlueFlag(Handler handler, float x, float y) {
	...
	public void render(Graphics g) {
		// Sem Camera
		if(visible)
			g.drawImage(Assets.IconBlueFlag, (int) (x - 0), (int) (y - 0), width, height, null);
	}
