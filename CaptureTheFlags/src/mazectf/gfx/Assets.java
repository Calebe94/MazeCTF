...
public class Assets {
	...
	public static void init(){
		...
		floor = ImageLoader.loadImage("res/textures/floor.png");

		pause = ImageLoader.loadImage("res/textures/pause.png");

		trap  = ImageLoader.loadImage("res/textures/trap.png");

		playerRed_Winner = ImageLoader.loadImage("res/textures/PlayerRedWins.png");
		playerBlue_Winner= ImageLoader.loadImage("res/textures/PlayerBlueWins.png");
